...
module.exports = {
	...
	plugins: [
		...
		...['index', 'choix-infographiste', 'demande-projet', 'index-document', 'rendu-non-conforme', 'demande-projet-infographiste', 'demande-projet-completed', 'demande-projet-rendu', 'demande-projet-paiement-ok'].map(el => {
